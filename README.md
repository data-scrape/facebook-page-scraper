...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/facebook-page-scraper?style=social)](https://github.com/data-scrape/facebook-page-scraper)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/facebook-page-scraper?style=social)](https://github.com/data-scrape/facebook-page-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/facebook-page-scraper)](https://github.com/data-scrape/facebook-page-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/facebook-page-scraper)](https://github.com/data-scrape/facebook-page-scraper/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Facebook page scraper - extract page posts, reviews, insights


<!-- SEO keywords: facebook page scraper, Facebook Page Scraper, facebook page scraper python, facebook page scraper github -->
...
- Extract Facebook page data: likes, followers, about info
- Page posts with text, media, reactions, comments
- Page reviews and ratings extraction
- Page transparency data (admins, creation date)
- Contact info: phone, email, website
- Post engagement metrics

## 🎯 Use Cases

Monitor brand page engagement, track competitor performance.
...
```bash
pip install git+https://github.com/data-scrape/facebook-page-scraper.git
```

### From source

```bash
git clone https://github.com/data-scrape/facebook-page-scraper.git
...
```bash
python facebook_page_scraper.py --query "your-query" --output results.json
```
...
### Is Facebook Page Scraper legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/facebook-page-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/facebook-page-scraper/issues)
